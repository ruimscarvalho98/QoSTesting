...
class Metaclass_GoTo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cf_messages.srv import _go_to
...
class GoTo(metaclass=Metaclass_GoTo):
    from cf_messages.srv._go_to import GoTo_Request as Request
    from cf_messages.srv._go_to import GoTo_Response as Response
