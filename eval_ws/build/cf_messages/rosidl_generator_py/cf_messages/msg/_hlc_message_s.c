...
bool cf_messages__msg__hlc_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cf_messages.msg._hlc_message.HLCMessage", full_classname_dest, 39) == 0);
  }
  cf_messages__msg__HLCMessage * ros_message = _ros_message;
  {  // command
  ...
  {  // use_current_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_current_yaw");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_current_yaw = (Py_True == field);
    Py_DECREF(field);
  }
  {  // duration
...
{
  /* NOTE(esteve): Call constructor of HLCMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cf_messages.msg._hlc_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HLCMessage");
  ...
  {  // use_current_yaw
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_current_yaw ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_current_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
