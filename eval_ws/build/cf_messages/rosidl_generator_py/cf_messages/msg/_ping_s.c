...
bool cf_messages__msg__ping__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cf_messages.msg._ping.Ping", full_classname_dest, 26) == 0);
  }
  cf_messages__msg__Ping * ros_message = _ros_message;
  {  // data
...
PyObject * cf_messages__msg__ping__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cf_messages.msg._ping");
