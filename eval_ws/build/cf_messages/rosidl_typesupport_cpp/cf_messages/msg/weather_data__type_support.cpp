...
static const _WeatherData_type_support_symbol_names_t _WeatherData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, msg, WeatherData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, msg, WeatherData)),
  }
};
...
{
  return &::cf_messages::msg::rosidl_typesupport_cpp::WeatherData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cf_messages, msg, WeatherData)() {
  return get_message_type_support_handle<cf_messages::msg::WeatherData>();
}
