...
static const _TakeOff_Request_type_support_symbol_names_t _TakeOff_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, TakeOff_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff_Request)),
  }
};
...
{
  return &::cf_messages::srv::rosidl_typesupport_cpp::TakeOff_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cf_messages, srv, TakeOff_Request)() {
  return get_message_type_support_handle<cf_messages::srv::TakeOff_Request>();
}
...
static const _TakeOff_Response_type_support_symbol_names_t _TakeOff_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, TakeOff_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff_Response)),
  }
};
...
{
  return &::cf_messages::srv::rosidl_typesupport_cpp::TakeOff_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cf_messages, srv, TakeOff_Response)() {
  return get_message_type_support_handle<cf_messages::srv::TakeOff_Response>();
}
...
static const _TakeOff_type_support_symbol_names_t _TakeOff_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, TakeOff)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff)),
  }
};
...
{
  return &::cf_messages::srv::rosidl_typesupport_cpp::TakeOff_service_type_support_handle;
}
