...
{
  new (message_memory) cf_messages::srv::TakeOff_Request(_init);
}

void TakeOff_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cf_messages::srv::TakeOff_Request *>(message_memory);
  typed_message->~TakeOff_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TakeOff_Request_message_member_array[2] = {
  {
    "height",  // name
    ...
    offsetof(cf_messages::srv::TakeOff_Request, height),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cf_messages::srv::TakeOff_Request, duration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TakeOff_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(cf_messages::srv::TakeOff_Request),
...
{
  return &::cf_messages::srv::rosidl_typesupport_introspection_cpp::TakeOff_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff_Request)() {
  return &::cf_messages::srv::rosidl_typesupport_introspection_cpp::TakeOff_Request_message_type_support_handle;
}
...
void TakeOff_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cf_messages::srv::TakeOff_Response(_init);
}

void TakeOff_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cf_messages::srv::TakeOff_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TakeOff_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cf_messages::srv::TakeOff_Response, ret),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TakeOff_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cf_messages::srv::TakeOff_Response),
...
{
  return &::cf_messages::srv::rosidl_typesupport_introspection_cpp::TakeOff_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff_Response)() {
  return &::cf_messages::srv::rosidl_typesupport_introspection_cpp::TakeOff_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers TakeOff_service_members = {
  ...
  // see get_service_type_support_handle<cf_messages::srv::TakeOff>()
...
get_service_type_support_handle<cf_messages::srv::TakeOff>()
{
  ...
  auto service_type_support =
    &::cf_messages::srv::rosidl_typesupport_introspection_cpp::TakeOff_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cf_messages, srv, TakeOff)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cf_messages::srv::TakeOff>();
}
