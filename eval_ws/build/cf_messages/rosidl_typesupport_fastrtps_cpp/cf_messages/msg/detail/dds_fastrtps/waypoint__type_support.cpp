...
#include "cf_messages/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cf_messages::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cf_messages::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &cf_messages::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
