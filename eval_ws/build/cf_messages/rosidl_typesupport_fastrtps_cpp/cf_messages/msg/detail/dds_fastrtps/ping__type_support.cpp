...
#include "cf_messages/msg/detail/ping__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cf_messages::msg::Ping *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cf_messages::msg::Ping *>(
    untyped_ros_message);
...
{
  return &cf_messages::msg::typesupport_fastrtps_cpp::_Ping__handle;
}
