...
#include "cf_messages/srv/detail/land__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cf_messages::srv::Land_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cf_messages::srv::Land_Request & ros_message)
{
  // Member: height
  cdr >> ros_message.height;
...
{
  auto typed_message =
    static_cast<const cf_messages::srv::Land_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cf_messages::srv::Land_Request *>(
    untyped_ros_message);
...
{
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, Land_Request)() {
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cf_messages
cdr_serialize(
  const cf_messages::srv::Land_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ret
  cdr << ros_message.ret;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cf_messages::srv::Land_Response & ros_message)
{
  // Member: ret
  cdr >> ros_message.ret;
...
{
  auto typed_message =
    static_cast<const cf_messages::srv::Land_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cf_messages::srv::Land_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, Land_Response)() {
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land_Response__handle;
}
...
{
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cf_messages, srv, Land)() {
  return &cf_messages::srv::typesupport_fastrtps_cpp::_Land__handle;
}
