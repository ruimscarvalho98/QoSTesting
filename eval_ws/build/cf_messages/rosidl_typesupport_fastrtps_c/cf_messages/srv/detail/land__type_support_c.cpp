...
#include "cf_messages/srv/detail/land__rosidl_typesupport_fastrtps_c.h"
...
using _Land_Request__ros_msg_type = cf_messages__srv__Land_Request;
...
size_t get_serialized_size_cf_messages__srv__Land_Request(
  const void * untyped_ros_message,
...
static uint32_t _Land_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cf_messages__srv__Land_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cf_messages
size_t max_serialized_size_cf_messages__srv__Land_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cf_messages__srv__Land_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cf_messages, srv, Land_Request)() {
...
using _Land_Response__ros_msg_type = cf_messages__srv__Land_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cf_messages
size_t get_serialized_size_cf_messages__srv__Land_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Land_Response__ros_msg_type * ros_message = static_cast<const _Land_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cf_messages__srv__Land_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cf_messages
size_t max_serialized_size_cf_messages__srv__Land_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cf_messages__srv__Land_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cf_messages, srv, Land_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cf_messages, srv, Land)() {
  return &Land__handle;
}
