...
#include "cf_messages/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = cf_messages__msg__Waypoint;
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cf_messages__msg__Waypoint(
...
{
  return max_serialized_size_cf_messages__msg__Waypoint(
    full_bounded, 0);
}
