...
#ifndef CF_MESSAGES__SRV__DETAIL__GO_TO__FUNCTIONS_H_
#define CF_MESSAGES__SRV__DETAIL__GO_TO__FUNCTIONS_H_
 ...
 * calls
 * cf_messages__srv__GoTo_Request__init().
...
/**
 * It calls
 * cf_messages__srv__GoTo_Request__fini()
 ...
 * cf_messages__srv__GoTo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cf_messages__srv__GoTo_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cf_messages__srv__GoTo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cf_messages
...
/**
 * It calls
 * cf_messages__srv__GoTo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cf_messages
...
/**
 * It allocates the memory for the array and calls
 * cf_messages__srv__GoTo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cf_messages
...
/**
 * It calls
 * cf_messages__srv__GoTo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CF_MESSAGES__SRV__DETAIL__GO_TO__FUNCTIONS_H_
