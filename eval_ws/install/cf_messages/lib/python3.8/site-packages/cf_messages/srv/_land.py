...
class Metaclass_Land(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cf_messages.srv import _land
...
class Land(metaclass=Metaclass_Land):
    from cf_messages.srv._land import Land_Request as Request
    from cf_messages.srv._land import Land_Response as Response
