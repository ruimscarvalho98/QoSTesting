...
bool cf_messages__srv__go_to__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cf_messages.srv._go_to.GoTo_Request", full_classname_dest, 35) == 0);
  }
  cf_messages__srv__GoTo_Request * ros_message = _ros_message;
  {  // x
...
PyObject * cf_messages__srv__go_to__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cf_messages.srv._go_to");
...
ROSIDL_GENERATOR_C_EXPORT
bool cf_messages__srv__go_to__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cf_messages.srv._go_to.GoTo_Response", full_classname_dest, 36) == 0);
  }
  cf_messages__srv__GoTo_Response * ros_message = _ros_message;
  {  // ret
